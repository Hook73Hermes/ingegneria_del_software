...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Espressione regolare che matcha soltanto numeri separati da virgole (con eventuali spazi)
    ...
    try {
        ...
        echo json_encode([
            'success' => false,
            'message' => 'Errore: matricola non presente nel database o dati mancanti.'
        ]);
        exit();
    }
}

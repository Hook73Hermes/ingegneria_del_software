...
$EMAIL_TEST = 'l.maietti@santannapisa.it';  // ← CAMBIA QUESTA!

// SMTP Config (NON modificare se usi mixer.unipi.it)
$SMTP_HOST = 'mixer.unipi.it';
$SMTP_PORT = 25;
$SMTP_FROM = 'no-reply-test@ing.unipi.it';
...
$pdf_dir = __DIR__ . '/data/pdf_generati/';
if (is_dir($pdf_dir)) {
...
$json_file = __DIR__ . '/data/ausiliario.json';
